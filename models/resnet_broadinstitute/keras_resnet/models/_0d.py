...
class ResNet0D(keras.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        x = keras.layers.Conv1D(64, (7, ), strides=(2, ), use_bias=False, name="conv1", **parameters)(x)
        ...
        if include_top:
            ...
            super(ResNet0D, self).__init__(inputs=inputs, outputs=x, *args, **kwargs)
        else:
            # Else output each stages features
            super(ResNet0D, self).__init__(inputs=inputs, outputs=outputs, *args, **kwargs)


class ResNet0D18(ResNet0D):
    """
    ...
    def __init__(self,
        ...
        super(ResNet0D18, self).__init__(
            inputs,
            blocks,
            block,
            parameters=parameters,
...
class ResNet0D34(ResNet0D):
    ...
    def __init__(self,
        ...
        super(ResNet0D34, self).__init__(
            inputs,
            blocks,
            block,
            parameters=parameters,
...
class ResNet0D50(ResNet0D):
    ...
    def __init__(self,
        ...
        super(ResNet0D50, self).__init__(
            inputs,
            blocks,
            block,
            parameters=parameters,
...
class ResNet0D101(ResNet0D):
    ...
    def __init__(self,
        ...
        super(ResNet0D101, self).__init__(
            inputs,
            blocks,
            block,
            parameters=parameters,
...
class ResNet0D152(ResNet0D):
    ...
    def __init__(self,
        ...
        super(ResNet0D152, self).__init__(
            inputs,
            blocks,
            block,
            parameters=parameters,
...
class ResNet0D200(ResNet0D):
    ...
    def __init__(self,
        ...
        super(ResNet0D200, self).__init__(
            inputs,
            blocks,
            block,
            parameters=parameters,
