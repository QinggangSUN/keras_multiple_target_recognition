...
"""This module implements a number of popular one-dimensional complex valued residual blocks."""
...
def basic_1d(filters,
    ...
    Usage:
        ...
        >>> from complex_networks_keras_tf1.models.resnet_models_1d import basic_1d
    ...
    def f(inputs, **kwargs):
        """Method for block."""
        outputs = keras.layers.ZeroPadding1D(padding=1, name=f'padding{stage_char}{block_char}_branch2a')(inputs)

        outputs = ComplexConv1D(filters, kernel_size, strides=stride, use_bias=False, spectral_parametrization=False,
        ...
        outputs = keras.layers.ZeroPadding1D(padding=1, name=f'padding{stage_char}{block_char}_branch2b')(outputs)

        outputs = ComplexConv1D(filters, kernel_size, use_bias=False, spectral_parametrization=False,
        ...
        if block == 0:
            shortcut = ComplexConv1D(filters, 1, strides=stride, use_bias=False, spectral_parametrization=False,
...
def bottleneck_1d(filters,
    ...
    Usage:
        ...
        >>> from complex_networks_keras_tf1.models.resnet_models_1d import bottleneck_1d
    ...
    def f(inputs, **kwargs):
        """Method for block."""
        outputs = ComplexConv1D(filters, 1, strides=stride, use_bias=False, spectral_parametrization=False,
        ...
        outputs = ComplexConv1D(filters*4, 1, strides=1, use_bias=False, spectral_parametrization=False,
        ...
        if block == 0:
            shortcut = ComplexConv1D(filters*4, 1, strides=stride, use_bias=False, spectral_parametrization=False,
                                     name=f'res{stage_char}{block_char}_branch1', **kwargs)(inputs)
