...
"""This module implements a number of popular one-dimensional complex valued DenseNet models."""
...
from .densenet_blocks_1d import dense1d_block, transition1d_block
...
from ..layers.pool import ComplexMaxPooling1D, ComplexAveragePooling1D, SpectralPooling1D


class DenseNet1D(keras.Model):
    ...
    def __init__(self,
        ...
        x_complex = ComplexConv1D(nb_filter, initial_kernel, strides=initial_strides,
        ...
        if subsample_initial_block:
            ...
            if pooling_func[0] == 'max':
                x_complex = ComplexMaxPooling1D(pool_size=3, strides=2, padding='same')(x_complex)
            elif pooling_func[0] == 'average':
                x_complex = ComplexAveragePooling1D(pool_size=3, strides=2, padding='same')(x_complex)

        # Add dense blocks
        for block_idx in range(nb_dense_block - 1):
            x_complex, nb_filter = dense1d_block(x_complex, nb_layers[block_idx], nb_filter, growth_rate,
        ...
        x_complex, nb_filter = dense1d_block(x_complex, final_nb_layer, nb_filter, growth_rate,
                                             activation=activation_conv, bottleneck=bottleneck,
                                             dropout_rate=dropout_rate, weight_decay=weight_decay)
        ...
        super(DenseNet1D, self).__init__(inputs=inputs, outputs=x, *args, **kwargs)


class DenseNet1D121(DenseNet1D):
    """Constructs a `keras.models.Model` according to the DenseNet1D121 specifications.
    ...
    Usage:
        ...
        >>> id1, od = 128, 3
        >>> inputs = Input(shape=(id1, 2))
        >>> model_densenet = DenseNet1D121(
                inputs,
                depthh=121,
                nb_dense_block=4,
                growth_rate=13,
    ...
    def __init__(self,
        ...
        super(DenseNet1D121, self).__init__(
            inputs,
            depth,
            nb_dense_block,
            growth_rate,
...
class DenseNet1D169(DenseNet1D):
    """Constructs a `keras.models.Model` according to the DenseNet1D169 specifications.
    ...
    def __init__(self,
        ...
        super(DenseNet1D169, self).__init__(
            inputs,
            depth,
            nb_dense_block,
            growth_rate,
...
class DenseNet1D201(DenseNet1D):
    """Constructs a `keras.models.Model` according to the DenseNet1D201 specifications.
    ...
    def __init__(self,
        ...
        super(DenseNet1D201, self).__init__(
            inputs,
            depth,
            nb_dense_block,
            growth_rate,
...
class DenseNet1D264(DenseNet1D):
    """Constructs a `keras.models.Model` according to the DenseNet1D264 specifications.
    ...
    def __init__(self,
        ...
        super(DenseNet1D264, self).__init__(
            inputs,
            depth,
            nb_dense_block,
            growth_rate,
...
class DenseNet1D161(DenseNet1D):
    """Constructs a `keras.models.Model` according to the DenseNet1D161 specifications.
    ...
    def __init__(self,
        ...
        super(DenseNet1D161, self).__init__(
            inputs,
            depth,
            nb_dense_block,
            growth_rate,
