"""
blocks/one_d_changed.py

Author: Qinggang SUN

Original Author: Ankit Gupta
...
from keras.layers import BatchNormalization, Activation, Conv1D, Concatenate, AveragePooling1D, Dropout
from keras.regularizers import l2

def H_l(k, bottleneck_size, kernel_width, weight_decay=1e-4, dropout_rate=None):
    """
...
def transition_block(pool_size=2, stride=2, theta=0.5, weight_decay=1e-4):
    """
