...
if __name__ == '__main__':
    ...
    def train_model(model, x_list, y_list, paras, path_save):
        ...
        if subset_acc_name == 'subset_acc_nhot':
            check_filename = os.path.join(
                path_check, f'weights_{modelname}'+'_{epoch:02d}_{val_subset_acc_nhot:.2f}.hdf5')
        ...
        if subset_acc_name == 'subset_acc_nhot':
            output_history(
                ['b', 'y'], [history.history['subset_acc_nhot'], history.history['val_subset_acc_nhot']],
            ...
            output_history(
                ['b', 'y'], [history.history['binary_acc'], history.history['val_binary_acc']],
    ...
    from models.models_recognition import build_model5, build_model6, build_model7, build_model8
    from models.models_recognition import build_model9, build_model90
    ...
    def search_models(x_list, y_list, model_list, path_save, **kwargs):
        ...
        if 90 in model_list:
            ...
            paras = {'i': i, 'j': j, 'epochs': 100, 'batch_size': 64, 'n_gpu': 1, 'subset_acc_name': subset_acc_name}
        ...
        if 5 in model_list:
            ...
            paras = {'i': i, 'j': j, 'epochs': 100, 'batch_size': 10, 'n_gpu': 1, 'subset_acc_name': subset_acc_name}
        ...
        if 12 in model_list:
            ...
            paras = {'i': i, 'j': j, 'epochs': 100, 'batch_size': 256, 'n_gpu': 1,
                     'test_check_models': False, 'subset_acc_name': subset_acc_name}
        ...
        if 10 in model_list:
            ...
            paras = {'i': i, 'j': j, 'epochs': 100, 'batch_size': 128, 'n_gpu': 1, 'subset_acc_name': subset_acc_name}
        ...
        if 11 in model_list:
            ...
            paras = {'i': i, 'j': j, 'epochs': 100, 'batch_size': 256, 'n_gpu': 1, 'subset_acc_name': subset_acc_name}
        ...
        if 15 in model_list:
            ...
            paras = {'i': i, 'j': j, 'epochs': 100, 'batch_size': 8, 'n_gpu': 1, 'subset_acc_name': subset_acc_name}
        ...
        if 18 in model_list:
            ...
            paras = {'i': i, 'j': j, 'epochs': 100, 'batch_size': 32, 'n_gpu': 1, 'subset_acc_name': subset_acc_name}
    ...
    PATH_ROOT = 'C:/data/shipsEar/multiple_class'
    PATH_SAVE_ROOT = '../result_recognition'
    PATH_SAVE_ROOT = 'E:/Python_project/under_target_recognition/input_compare/result_recognition'
    ...
    for win_i, hop_i in zip(WIN_LIST, HOP_LIST):
        ...
        for i in range(1, 2):
            for j in range(-3, -4, -1):
                search_models(x_list, y_list, [11, 14], path_save, **
                              {'i': i, 'j': j, 'subset_acc_name': subset_acc_name})
        ...
        for i in range(1, 2):
            for j in range(-3, -4, -1):
                search_models(x_list, y_list, [12, 13, 10], path_save, **
                              {'i': i, 'j': j, 'subset_acc_name': subset_acc_name})
        ...
        for n_mels_i in N_MELS:
            for n_mfcc_i in N_MFCCS:
                ...
                x_list, y_list = load_data(path_root=PATH_ROOT, form_src='mfcc', scaler_data='or', sub_set_way='rand',
                                           **{'win_length': win_i, 'hop_length': hop_i,
                                               'n_mels': n_mels_i, 'n_mfcc': n_mfcc_i})
    ...
    for high_i, low_i in zip(HIGH_LIST, LOW_LIST):
        for cutoff_i in CUTOFF_LIST:
            ...
            for i in range(1, 2):
                for j in range(-3, -4, -1):
                    search_models(x_list, y_list, [7, 8], path_save, **
                                  {'i': i, 'j': j, 'subset_acc_name': subset_acc_name})
            ...
            for i in range(1, 2):
                for j in range(-3, -4, -1):
                    search_models(x_list, y_list, [90, 9, 6, 5], path_save, **
                                  {'i': i, 'j': j, 'subset_acc_name': subset_acc_name})
    ...
    for win_i, hop_i in zip(WIN_LIST, HOP_LIST):
        ...
        for i in range(1, 2):
            for j in range(-3, -4, -1):
                search_models(x_list, y_list, [23, 24], path_save, **
                              {'i': i, 'j': j, 'subset_acc_name': subset_acc_name})
